    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return _context4.abrupt("return", axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:3065/api/user/', signUpData));
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function signUp$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          console.log(action.data); //yield call(signUpAPI);
...
//# sourceMappingURL=_app.js.ffb60bbc8df97c1b7933.hot-update.js.map